...
public sealed class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages
{
    ...
    public IEnumerable<PluginPageInfo> GetPages() => new[] { new PluginPageInfo { Name = "config.html", EmbeddedResourcePath = "SubtitleCloudPlugin.PluginPage.html" } };
}

public sealed class PluginConfiguration : BasePluginConfiguration
{
    public string ServiceUrl { get; set; } = "http://127.0.0.1:8898";
